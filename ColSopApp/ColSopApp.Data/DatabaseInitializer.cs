...
{
    public class DatabaseInitializer : DropCreateDatabaseIfModelChanges<ColAppDbContext>
    {
        protected override void Seed(ColAppDbContext context)
        {
            Initialize(context);
            base.Seed(context);
        }

        public void Initialize(ColAppDbContext context)
        {
            try
            {
